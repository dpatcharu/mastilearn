...
export function DiscoveryCard({ category, href, image, saves = "1.2k", title, vibe }: DiscoveryCardProps) {
  return (
    <article className="mb-3 break-inside-avoid overflow-hidden rounded-[1.35rem] bg-white shadow-[0_16px_45px_rgba(15,23,42,0.08)] ring-1 ring-slate-200/70 transition hover:-translate-y-1 hover:shadow-xl lg:mb-5 lg:rounded-[1.75rem]">
      <a className="block" href={href}>
        <div className="relative min-h-56 overflow-hidden bg-slate-100 sm:min-h-64">
      ...
      <div className="p-3 lg:p-4">
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <h3 className="mt-1 text-sm font-black leading-tight text-slate-950 lg:text-lg">{title}</h3>
          </div>
